...
{
    // NOTE: You can use the "Rename" command on the "REN_User_ValidateUserefactor" menu to change the interface name "IUltraERPService" in both code and config file together.
    [ServiceContract]
    public interface IUltraERPService
    {
        ...
        [OperationContract]
        EN_User_ValidateUserResponse EN_User_ValidateUser(string userName, string password);
